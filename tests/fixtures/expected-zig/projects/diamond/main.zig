...
fn buildFile_0(circuit: *engine.Circuit) !struct {
    ...
    try circuit.connect(inst_r_2.output_out.port("out"), comp_comb_3.port("b"));
    try circuit.connect(comp_comb_3.port("out"), comp_out_4.port("in"));
    return .{
        .input_a = comp_a_0,
...
const file_info_blob: []const u8 = &.{
    1, 0, 0, 0, 0, 0, 0, 0, 11, 0, 0, 0, 35, 0, 0, 0,
    ...
    0, 0, 1, 0, 0, 0, 97, 1, 0, 0, 0, 10, 0, 0, 0, 3,
    0, 0, 0, 111, 117, 116,
};
...
const sub_circuits: []const SubCircuit = &.{
    .{ .instance_path = &.{ "root.circ", "l" }, .target_file_id = 1 },
    .{ .instance_path = &.{ "root.circ", "l", "b" }, .target_file_id = 8 },
    .{ .instance_path = &.{ "root.circ", "r" }, .target_file_id = 2 },
    .{ .instance_path = &.{ "root.circ", "r", "b" }, .target_file_id = 8 },
};
...
const debug_paths: []const DebugPath = &.{
    ...
    .{ .component_id = 1, .segments = &.{ "root.circ", "l", "in" } },
    .{ .component_id = 2, .segments = &.{ "root.circ", "l", "b", "in" } },
    .{ .component_id = 3, .segments = &.{ "root.circ", "l", "b", "out" } },
    .{ .component_id = 4, .segments = &.{ "root.circ", "l", "out" } },
    .{ .component_id = 5, .segments = &.{ "root.circ", "r", "in" } },
    .{ .component_id = 6, .segments = &.{ "root.circ", "r", "b", "in" } },
    .{ .component_id = 7, .segments = &.{ "root.circ", "r", "b", "out" } },
    .{ .component_id = 8, .segments = &.{ "root.circ", "r", "out" } },
    .{ .component_id = 9, .segments = &.{ "root.circ", "comb" } },
    .{ .component_id = 10, .segments = &.{ "root.circ", "out" } },
};

const topology_blob: []const u8 = "circ.topology.v0.min";

const PtrLen = extern struct { ptr: ?[*]const u8, len: usize };
const expected_component_count: usize = 11;
