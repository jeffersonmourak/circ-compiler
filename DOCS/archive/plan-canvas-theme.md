...
- The design handoff (`README.md`, `circ-site-theme.js`, the two `.dc.html` sheets, the harness files) was deleted from the tree after the port; `git show 02e56f4~0:DOCS/archive/design/canvas-theme/README.md` recovers it.
