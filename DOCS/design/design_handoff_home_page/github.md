...
- Home page proposal (`Home Page Proposal.dc.html`): current index.astro rebuilt at 640 beside a 1100-wide proposal — hero with live circuit, Write/Check/Run pillars, CodePreview, gallery cards, InstallLine, Lineage
...
| Screen | Repo files |
|---|---|
| Home Page Proposal.dc.html — current + 4a | circ-compiler: site/src/pages/index.astro, site/src/components/{Nav,Footer,CodePreview,InstallLine,LiveCanvas}.astro, site/src/styles/global.css (hero, .cp, .lc, .install, .lineage) |
