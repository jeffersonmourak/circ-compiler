...
lib/
  ...
  memory.zig               Global arena (ArenaAllocator over page_allocator; reset() for libcirc)
...
build/
  frontend_modules.zig     The front-end module graph the CLI, libcirc.a and libcirc.wasm share
