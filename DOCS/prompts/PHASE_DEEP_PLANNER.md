...
1. `DOCS/PLANS_PROMPT.md` — extract the Phase Index table (phase numbers, names, what ships). If the file is absent, no initiative is active: stop and run `PHASE_MACRO_PLANNER.md` first.
