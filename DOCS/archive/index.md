...
| [design/canvas-theme/](design/canvas-theme/README.md) | The design handoff the canvas-theme initiative ported: the two asset sheets, `circ-site-theme.js` (the port target), the harness files and the README that names what to port. A reference, not a plan; the plan's highlight view lands beside it when the initiative archives. |
