...
pub const templates = [_]CodeTemplate{
    ...
    .{ .code = .E014, .default_message = "width mismatch" },
    .{ .code = .E015, .default_message = "sub-circuit is not parametric" },
    .{ .code = .E016, .default_message = "parameter count mismatch" },
    .{ .code = .E017, .default_message = "memory parameter list malformed" },
    .{ .code = .E018, .default_message = "memory width out of range" },
