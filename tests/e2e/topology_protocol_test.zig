...
test "topology host protocol: inverter round-trip via Node" {
    ...
    const script =
        ...
        \\        const readScalar = (id) => (instance.exports.getOutputDefined(id) === 0n) ? 2 : (instance.exports.getOutputValue(id) === 0n ? 0 : 1);
        \\        const initialOut = readScalar(1);
        \\        instance.exports.setPin(0, 0n, 1n);
        ...
        \\        instance.exports.setPin(0, 1n, 1n);
        \\        instance.exports.run();
