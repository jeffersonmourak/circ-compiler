...
Built-in macros (`or`, `nand`, `nor`, `xor`, `xnor`) are auto-imported from a virtual `<builtin>/` filesystem and compose like any user sub-circuit. See `DOCS/language.md` for the full surface.
