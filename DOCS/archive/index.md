...
| [plan-dead-code-removal.md](plan-dead-code-removal.md) | Dead-code removal plan (highlights; the bundle was squashed away and is not in history) |
| [plan-test-speed.md](plan-test-speed.md) | Test-suite speed-up plan (highlights; the bundle was squashed away and is not in history) |
| [plan-zig-free-cli.md](plan-zig-free-cli.md) | Self-contained `circ-compile`: no Zig at user runtime (highlights; the bundle was squashed away and is not in history) |
| [plan-cli-preview.md](plan-cli-preview.md) | `circ-compile <file> --preview`: ASCII circuit schematic rendering with opaque/expanded macro modes and ANSI color (highlights; the bundle was squashed away and is not in history) |
