...
function emitLandingTwin(): void {
  const lines = [
    ...
    '',
    '1. **Write a .circ file.** Use any text editor, or write in the playground to check your wiring as you type.',
    '2. **Compile it.** Run circ-compile to produce a self-contained WebAssembly module. Use --preview to print a schematic in your terminal.',
    '3. **Run the circuit.** Set input pins and read outputs from JavaScript. Run the module in a browser, in Node, or in the playground.',
    '',
    ...
    '## From the gallery',
    '',
    `[two-bit-adder](${SITE_URL}/gallery.md): Adds two 2-bit numbers and produces a sum and carry.`,
    '',
    `[four-bit-adder](${SITE_URL}/gallery.md): Adds two 4-bit numbers, passing the carry from one bit to the next.`,
    '',
    `[rom-lookup](${SITE_URL}/gallery.md): Stores the squares of 0 through 15. Set an address to read its square.`,
    '',
