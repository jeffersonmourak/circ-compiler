...
fn buildFile_1(circuit: *engine.Circuit) !struct {
    ...
    const comp_a_0 = try circuit.createComponent(.{ .input_pin_gate = .{} });
    const inst_inv1_1 = try buildFile_2(circuit);
    const inst_inv2_2 = try buildFile_2(circuit);
...
const file_info_blob: []const u8 = &.{
    1, 0, 0, 0, 0, 0, 0, 0, 10, 0, 0, 0, 7, 0, 0, 0,
...
const sub_circuits: []const SubCircuit = &.{
    ...
    .{ .instance_path = &.{ "root.circ", "d", "inv1" }, .target_file_id = 2 },
    .{ .instance_path = &.{ "root.circ", "d", "inv2" }, .target_file_id = 2 },
};
