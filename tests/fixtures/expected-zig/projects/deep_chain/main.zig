...
fn buildFile_8(circuit: *engine.Circuit) !struct {
...
fn buildFile_9(circuit: *engine.Circuit) !struct {
...
const file_info_blob: []const u8 = &.{
    1, 0, 0, 0, 0, 0, 0, 0, 10, 0, 0, 0, 34, 0, 0, 0,
...
const sub_circuits: []const SubCircuit = &.{
    ...
    .{ .instance_path = &.{ "root.circ", "u", "u" }, .target_file_id = 7 },
    .{ .instance_path = &.{ "root.circ", "u", "u", "u" }, .target_file_id = 8 },
    .{ .instance_path = &.{ "root.circ", "u", "u", "u", "u" }, .target_file_id = 9 },
};
